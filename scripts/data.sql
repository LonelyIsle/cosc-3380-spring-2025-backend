-- EMPLOYEE --
INSERT INTO `employee` (`first_name`, `last_name`, `role`, `hourly_rate`, `email`, `password`, `reset_password_question`, `reset_password_answer`) VALUES ('Chad', 'Gilmore', 1, 30.00, 'manager@domain.com', '$2b$10$dqmrkVGpQxnlj/c.dv0OROiWGRicBoewqeyCiM1EQzKtFQlSIZKJ.', 'How many states are there in the United States?', '$2b$10$cfd3GSy13NfXlRh8fXZequ464lS21Q.Ec2EcahsOpX0y.jOZOV5jK'); -- 123456, 50
INSERT INTO `employee` (`first_name`, `last_name`, `role`, `hourly_rate`, `email`, `password`, `reset_password_question`, `reset_password_answer`) VALUES ('Peter', 'Parker', 0, 15.00, 'staff@domain.com', '$2b$10$dqmrkVGpQxnlj/c.dv0OROiWGRicBoewqeyCiM1EQzKtFQlSIZKJ.', 'How many states are there in the United States?', '$2b$10$cfd3GSy13NfXlRh8fXZequ464lS21Q.Ec2EcahsOpX0y.jOZOV5jK'); -- 123456, 50
INSERT INTO `employee` (`first_name`, `last_name`, `role`, `hourly_rate`, `email`, `password`, `reset_password_question`, `reset_password_answer`) VALUES ('Aria', 'Park', 0, 15.00, 'employee@example.com', '$2b$10$o8xtDsSqut4PMZx7HLBgP.TcgNokt1J/K08X75Iu9SyCfMF3GIGbW', 'How many states are there in the United States?', '$2b$10$cfd3GSy13NfXlRh8fXZequ464lS21Q.Ec2EcahsOpX0y.jOZOV5jK'); -- Password123, 50

-- CUSTOMER -- 
INSERT INTO `customer` (`first_name`, `last_name`, `email`, `password`) VALUES ('Ava', 'Dean', 'somerandom@gmail.com', '$2b$10$nD53mm4ndgrdeMwpLkMsbOwlXVIKY34/nxSb1swYO.Udt3/Pcl9fm'); -- IWant2Login!
